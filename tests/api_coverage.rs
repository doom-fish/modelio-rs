...
fn asset_mesh_material_and_texture_surface_is_present() {
    ...
    assert_contains_all(
        ...
        &[
            ...
            "mdl_material_new",
            "mdl_material_new_with_scattering_function",
            "mdl_material_scattering_function",
            "mdl_scattering_function_new",
            "mdl_physically_plausible_scattering_function_new",
...
fn transform_mesh_buffer_resolver_and_light_probe_surface_is_present() {
    ...
    assert_contains_all(
        &bridge,
        &[
            "mdl_asset_resolver_new_with_callback",
            "mdl_asset_resolver_can_resolve_named",
            "mdl_relative_asset_resolver_new",
            "mdl_mesh_buffer_allocator_new_with_callback",
            ...
            "mdl_transform_component_new_with_callback",
            "mdl_transform_component_matrix",
            "mdl_transform_op_new_with_callback",
            "mdl_transform_op_copy_double4x4_at_time",
